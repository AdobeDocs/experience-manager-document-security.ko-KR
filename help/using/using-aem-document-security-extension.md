...
Document Security 웹 페이지에서 정책을 만드는 데 사용할 수 있는 일부 정책 설정은 Word, Excel 및 PowerPoint 파일에서 지원되지 않습니다. 다음 테이블에서는 정책 권한이 Word, Excel 및 PowerPoint 기능에 매핑되는 방식을 설명합니다.
...
>[!NOTE]
>
>임베드된 파일에 대한 링크가 포함된 파일에 정책을 적용하면 링크된 파일에 정책이 적용되지 않습니다 Microsoft® Office용 Document Security는 링크된 파일에 대한 보호를 확장하지 않습니다.
